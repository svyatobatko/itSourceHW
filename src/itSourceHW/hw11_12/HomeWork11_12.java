...
public class HomeWork11_12 {
	public static void main(String[] args) throws IOException {
		...
		// хешмапа делается по названию товара (ключь) и количество в корзине
		// (значение)
		Shop shop = new Shop();
	...
	static void printWareInConsole(List<Ware> myWare) {
		...
		for (Ware ware2 : myWare) {
			...
			System.out.printf("%25s",
					ware2.getDimHeight() + "x" + ware2.getDimWidth() + "x" + ware2.getDimDepth() + " мм |");
	...
	static void addWareInConsole(Shop shop) throws IOException {
		...
		System.out.println(
				"Для добавления товара введите его: Название, Вес, Ширина, Высота, Глубина, Кол-во, Цена. Все вводить через ; в одну строку.");
